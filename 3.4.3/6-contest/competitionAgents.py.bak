...
class MyPacmanAgent(CompetitionAgent):
    ...
    def allPointsTillCrossroad(self,gameState,pos,direction,count=1):
        x,y = pos
        walls = gameState.getWalls()
        ...
        return [((x,y), count)] + self.allPointsTillCrossroad(gameState,newPos,newDirection,count+1)# new position and new direction
